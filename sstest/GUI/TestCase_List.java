...
//							query_day, result_contets, result_author, result_day, query_tag, query_output);
			...
			deleteButton.addActionListener(new AbstractAction() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					boolean option = sstest.Common.Dialog.YesNoDialog("Are you sure you want to delete this Query?");
					...
					if (option == true){
						...
						sstest.Common.Dialog.NormalDialog("The Query has been deleted");
