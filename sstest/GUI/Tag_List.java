...
import sstest.Class.QueryDetail;
import sstest.Class.QueryResults;
import sstest.Class.TagQuery;
import sstest.Common.Database;
import sstest.ExecRegressionTest.DB;
import sstest.ExecRegressionTest.Exec;
import sstest.GUI.TestCase_Add.DeleteAction;
import sstest.GUI.TestCase_List.ButtonEditor;
import sstest.GUI.TestCase_List.ButtonRenderer;
import sstest.GUI.TestCase_List.MyTableModel;
		...
		tag_list_Model = new MyTableModel(columnName_list, rowNum){
			...
			tag_deleteButton.addActionListener(new AbstractAction() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					Database.connect();
					boolean option = sstest.Common.Dialog.YesNoDialog("Are you sure you want to delete this Tag?");
					if (option == true){
						//tagidを探してきている！
