...
public class TestResult_Detail extends JFrame {
	...
	public static void display(ArrayList<RegressionTestResult> al, int queryID,
	...
	public TestResult_Detail(ArrayList<RegressionTestResult> al, int queryID,
			ArrayList<QueryResults> query_result) {
...
//					});
		...
		replaceButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				boolean option = ssql_regressiontest.Common.Dialog.YesNoDialog("Are you sure you want to replace expected result?");
				if (option == true){
